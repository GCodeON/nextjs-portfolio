...
// const Carousel = require('../assets/carousel3d/Carousel')
...
export default class Work extends React.Component {
  ...
  init(images) {
    console.log('init carousel', renderer);
  ...
  createCarousel(radius, width, height) {
    ...
    for (var i=0; i < this.l; i++)
    {
        ...
        this.images[i].image.onload=function(i){ return function(){ this.buildCarousel(scope, i);} }(i);
  ...
  buildCarousel(scope, i) {
    ...
    if (img.caption) {
      ...
      height           = 2;
      text3d           = new THREE.TextGeometry( img.caption,{size: size, height: height, curveSegments: 2, font:'vortice-concept'});
  ...
  onDblClick( e ) {
    ...
    onDocumentMouseDown( e ) {
      ...
      container.addEventListener( 'mouseout', this.onDocumentMouseOut, false );
    ...
    onDocumentMouseUp( e ) {
      ...
      container.removeEventListener( 'mouseout', this.onDocumentMouseOut, false );
    }
